...
const EntryCard = ({ entry,aiImageChanged,setAiImageChanged}) => {
  return (
    <div className='card bg-base-100 shadow-xl'>
      ...
      <MoodAIAnalysisImage entry={entry} aiImageChanged={aiImageChanged} setAiImageChanged={setAiImageChanged}/>
      </div>
    </div>
  );
};
